  ...
  try {
    ...
    result.innerHTML = `
      <div style="text-align:center;padding:20px 0;">
        ...
        <div style="margin-top:14px;font-size:12px;color:var(--primary);cursor:pointer;" onclick="document.getElementById('aiResultModal').classList.remove('show');location.href='/profile.html'">前往设置 →</div>
      </div>
    `;
  }
}
